...
//-------------------------------------------------------
// ESP32, SenduWing Tx, Internal SX1280 2400, for H17
//-------------------------------------------------------
...
#define UARTD_USE_TX_IO           IO_P22
#define UARTD_USE_RX_IO           IO_P21
...
#define UARTF_USE_TX_IO           -1 // Or choose another unused pin/test pad
...
#define SPI_CS_IO                 IO_P25
#define SPI_MISO                  IO_P14
#define SPI_MOSI                  IO_P27
#define SPI_SCK                   IO_P26
#define SPI_FREQUENCY             18000000L
#define SX_RESET                  IO_P4
#define SX_DIO                    IO_P13
#define SX_BUSY                   IO_P15
#define SX_TX_EN                  IO_P32
#define SX_RX_EN                  IO_P33
...
#define ESP_RESET                 IO_P20 // backpack_en
#define ESP_GPIO0                 IO_P19 // backpack_boot inverted?
