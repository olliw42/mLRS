...
#define UARTB_USE_UART3 //1 // serial
...
#define SX_DIO0_GPIO_AF_EXTI_LINEx    LL_GPIO_AF_EXTI_LINE11
...
void sx_dio0_init_exti_isroff(void)
{
...
void sx_dio0_enable_exti_isr(void)
{
