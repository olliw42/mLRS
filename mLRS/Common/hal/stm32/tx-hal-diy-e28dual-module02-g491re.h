...
#define SX2_DIO                   IO_PA12
#define SX2_BUSY                  IO_PA11
#define SX2_RX_EN                 IO_PB12
#define SX2_TX_EN                 IO_PC7

#define SX2_DIO_SYSCFG_EXTI_PORTx     LL_SYSCFG_EXTI_PORTA
#define SX2_DIO_SYSCFG_EXTI_LINEx     LL_SYSCFG_EXTI_LINE12
