...
class FhssBase
{
  public:
    void Init(uint8_t fhss_num, uint32_t seed, uint8_t frequency_band)
    {
        ...
        case SETUP_FREQUENCY_BAND_433_MHZ: config_i = FHSS_CONFIG_433_MHZ; break; // first pass
        default:
    ...
    uint8_t GetCurrFrequencyBand(void)
    {
        ...
        case FHSS_CONFIG_433_MHZ: return SETUP_FREQUENCY_BAND_433_MHZ; // first pass
        }
        while (1) {} // should not happen, but play it safe
        return 0;
    }
