...
#define VERSION             208 // leading zero makes it octal!
#define VERSIONONLYSTR      "v0.2.08"
...
#define SETUP_TX_SERIAL_DESTINATION     1 // 0: serial port, 1: mBridge, 2: serial2 (BT/ESP) port
