...
#define VERSION             328 // leading zero makes it octal!
#define VERSIONONLYSTR      "v0.3.28"
...
#define MODE_143HZ_FLRC_SEND_FRAME_TMO_MS     3  // just needs to be larger than toa, not critical
