...
#define FHSS_NUM_433MHZ                 2  // 2 since 1 is needed for bind
#define FHSS_NUM_70CM_HAM               18 // to match 2.4 GHz at 31 Hz
#define FHSS_NUM_70CM_HAM_19HZ          12 // to match 2.4 GHz at 19 Hz
#define FHSS_NUM_868MHZ                 6  // it's a very narrow band
#define FHSS_NUM_915MHZ_FCC             25 // https://www.ecfr.gov/current/title-47/chapter-I/subchapter-A/part-15/subpart-C/subject-group-ECFR2f2e5828339709e/section-15.247#p-15.247(a)(1)(i)
#define FHSS_NUM_866MHZ_IN              3  // 3 since 1 is needed for bind
#define FHSS_NUM_2P4GHZ                 24
#define FHSS_NUM_2P4GHZ_31HZ            18
#define FHSS_NUM_2P4GHZ_19HZ            12 // was 24, but a cycle takes then 1.3 sec! would need long disconnect
