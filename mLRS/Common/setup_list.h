...
#define SETUP_MSK_TX_SER_DEST2        &SetupMetaData.Tx_SerialDestination2_allowed_mask // this we generate from the hal
...
#define SETUP_PARAMETER_LIST_TX_MAIN \
  ...
  X( Setup.Tx[0].SerialDestination2,LIST, "Tx Ser Dest2",     "TX_SER_DEST2",     0,0,0,"", "none,serial,wbridge,serial2", SETUP_MSK_TX_SER_DEST2 )\
