...
uint8_t txBufSpace(void)
{
	uint16_t space = UARTB_RXBUFSIZE - serial.bytesAvailable();
	space = (100 * (space >> 3)) / (UARTB_RXBUFSIZE >> 3);
	return space;
}
...
*/
  ...
  fmav_msg_radio_status_pack(
      ...
      rssi, remrssi, txBufSpace(), UINT8_MAX, UINT8_MAX, 0, 0,
...
int8_t snr = (stats.last_rx_antenna == ANTENNA_1) ? stats.last_rx_snr1 : stats.last_rx_snr2;
  ...
  fmav_msg_radio_status_v2_pack(
      ...
      51, // sysid, SiK uses 51, 68
      MAV_COMP_ID_TELEMETRY_RADIO,
      rssi, (128 + rssi), rxstats.GetLQ(), snr,
