...
typedef enum {
    ...
    FRAME_STATE_SEND_CMD_RX_SETUPDATA,
    FRAME_STATE_SEND_CMD_RX_ACK,
} FRAME_STATE_ENUM;
...
int main_main(void)
{
  ...
  frame_state = FRAME_STATE_SEND_NORMAL;
