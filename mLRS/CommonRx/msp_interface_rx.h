                            ...
                            if (msp_msg_ser_in.payload[i] != ';') {
                                ...
                                for (uint8_t n = 0; n < INAV_BOXES_COUNT; n++) {
                                    if (!strcmp(s, inavBoxes[n].boxName)) {
                                        if (state != 0xFF) { state = 0xFF; new_payload[new_len++] = 0xFF; }
                                        new_payload[new_len++] = n;
                                        found = true;
                                ...
                                if (!found) {
                                    if (state != 0xFE) { state = 0xFE; new_payload[new_len++] = 0xFE; }
                                    for (uint8_t n = 0; n < strlen(s); n++) new_payload[new_len++] = s[n];
                                    new_payload[new_len++] = ';';
                                }
                                pos = 0;
